...
const Landing = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-violet-50 via-fuchsia-50 to-cyan-50">
            ...
            <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-xl border-b border-gray-200 shadow-sm">
                <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        <div className="p-1.5 bg-gradient-to-br from-violet-500 to-fuchsia-500 rounded-xl">
                    ...
                    <div className="flex items-center gap-2">
                        <button
                            ...
                            className="px-4 py-2 text-sm text-gray-700 font-semibold hover:text-violet-600 transition-colors"
                        >
                            Login
                        </button>
                        <button
                            onClick={() => navigate('/signup')}
                            className="px-4 py-2 text-sm bg-gradient-to-r from-violet-500 to-fuchsia-500 text-white font-bold rounded-xl hover:shadow-lg hover:scale-105 transition-all"
                        >
                            Get Started
                        </button>
                    </div>
            ...
            {/* Hero Section */}
            <AnimationWrapper className="pt-24 pb-16 px-4 md:px-6">
                    ...
                    <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
                        ...
                        <div className="space-y-6 text-center lg:text-left">
                            ...
                            <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
                                <button
                                    onClick={() => navigate('/signup')}
                                    className="w-full sm:w-auto px-8 py-4 bg-gradient-to-r from-violet-500 to-fuchsia-500 text-white font-bold rounded-xl hover:shadow-2xl hover:scale-105 transition-all flex items-center justify-center gap-2"
                                >
                                    Start Free Today
                                    <ArrowRight size={20} />
                                </button>
                                <button
                                    onClick={() => navigate('/login')}
                                    className="w-full sm:w-auto px-8 py-4 bg-white border-2 border-gray-200 text-gray-700 font-bold rounded-xl hover:border-violet-300 hover:shadow-lg transition-all"
                                >
                                    Sign In
                                </button>
                            </div>

                            <div className="flex items-center justify-center lg:justify-start gap-6 pt-2 flex-wrap">
                                <div className="text-center">
                                    <p className="text-2xl md:text-3xl font-bold text-gray-800">10K+</p>
                                    <p className="text-gray-500 text-sm">Active Users</p>
                                </div>
                                <div className="h-10 w-px bg-gray-300 hidden sm:block" />
                                <div className="text-center">
                                    <p className="text-2xl md:text-3xl font-bold text-gray-800">50K+</p>
                                    <p className="text-gray-500 text-sm">Workouts Logged</p>
                                </div>
                                <div className="h-10 w-px bg-gray-300 hidden sm:block" />
                                <div className="text-center">
                                    <p className="text-2xl md:text-3xl font-bold text-gray-800">4.9★</p>
            ...
            {/* CTA Section */}
            <div className="py-16 md:py-20 px-4 md:px-6 bg-gradient-to-br from-violet-600 via-fuchsia-600 to-cyan-600">
                <AnimationWrapper className="max-w-4xl mx-auto text-center space-y-6">
                    ...
                    <button
                        onClick={() => navigate('/signup')}
                        className="px-8 py-4 bg-white text-violet-600 font-bold text-lg rounded-xl hover:shadow-2xl hover:scale-105 transition-all"
                    >
                        Create Free Account
                    </button>
